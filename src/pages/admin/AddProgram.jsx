                         ...
                         <div className='episode_section'>
                          ...
                          <div className='radio_btns'>
                            <div className='course_type'>
                                <h5>Course Type</h5>
                              <label for="paid"><input type='radio' name='course' id='paid'/>Paid</label>
                              <label for="free"><input type='radio' name='course' id="free"/>Free</label>
                            </div>
                            <div className='tags'>
                            <h5>Tags</h5>
                            <label for="popular"><input type='radio' name='tags' id='popular'/>Popular</label>
                              <label for="recommended"><input type='radio' name='tags' id="recommended"/>Recommended</label>
                            </div>
                          </div>
                    ...
                    <Col md={5}>
                      <div className="video_upload_wrap">
                        ...
                        <div className='select_thumbnail_imgs'>
                         <button  className='thumbnail_link'><Image src={thumbnail}/></button>
                         <button  className='thumbnail_link'><Image src={thumbnail}/></button>
                         <button  className='thumbnail_link'><Image src={thumbnail}/></button>
                         <button  className='thumbnail_link'><Image src={thumbnail}/></button>
                        </div>
